...
%
% NUMTEST 3 — Test funkcji o ostrym maksimum
% Cel testu:
%   Ocenić, jak metoda radzi sobie w obecności ostrego maksimum (funkcja 
%   posiada bardzo silny pik w pobliżu punktu (0, 0)) i zbadać, jak 
...
fprintf('----------------- NUMTEST 3 ---------------\n');
fprintf('-------- Funkcja o ostrym maksimum --------\n');
fprintf('------ f(x, y) = 1/sqrt(x²+y²+10⁻⁶) -------\n');

% Definicja funkcji testowej
f = @(x,y) 1./sqrt(x.^2+y.^2+1e-6);
