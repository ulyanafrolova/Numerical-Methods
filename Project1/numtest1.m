...
%
% NUMTEST 1 — Test funkcji oscylującej
% Cel testu:
%   Ocenić zachowanie metody dla funkcji oscylującej oraz zbadać, jak 
...
fprintf('------------------- NUMTEST 1 ------------------\n');
fprintf('-------------- Funkcja oscylująca --------------\n');
fprintf('---------- f(x, y) = sin(10x+3y+0.7) -----------\n');

% Definicja funkcji testowej
f = @(x,y) sin(10*x + 3*y + 0.7);

% Obliczenie dokładnej wartości całki metodą wbudowaną integral2
