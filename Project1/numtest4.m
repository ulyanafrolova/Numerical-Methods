...
%
% NUMTEST 4 — Test funkcji lokalnie skupionej
% Cel testu:
%   Ocenić zachowanie metody dla funkcji lokalnie skupionej, ale z 
%   lokalnym maksimum, zbadać jak podział obszaru wpływa na dokładność 
%   wyniku
% Działanie:
...
fprintf('------------------- NUMTEST 4 ------------------\n');
fprintf('----------- Funkcja lokalnie skupiona-----------\n');
fprintf('---- f(x, y) = 1/(1+50((x-0.3)²+(y+0.1)²)) -----\n');

% Definicja funkcji testowej
f = @(x,y) 1 ./ (1 + 50*((x - 0.3).^2 + (y + 0.1).^2));
